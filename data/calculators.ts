...
export type CalculatorConfig = {
  ...
  related: string[];
  /** Extra slugs that 301 to this calculator. */
  redirectFrom?: string[];
  title: string;
  description: string;
  example: string;
...
export const calculators: CalculatorConfig[] = [
  {
    ...
    aliases: ['home loan calculator', 'house payment calculator', 'mortgage payment calculator', 'home loan emi calculator', 'house loan emi calculator', 'monthly mortgage estimator'],
    related: ['loan-calculator', 'emi-calculator', 'loan-prepayment-calculator', 'car-payment-calculator'],
    redirectFrom: ['home-loan-calculator', 'house-loan-emi-calculator'],
  ...
  },
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['personal loan calculator', 'monthly payment calculator', 'loan repayment calculator', 'installment calculator', 'borrowing cost calculator'],
    related: ['mortgage-calculator', 'emi-calculator', 'car-payment-calculator', 'loan-prepayment-calculator'],
  ...
  },
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['interest growth calculator', 'savings growth calculator', 'future value calculator', 'compounding calculator'],
    related: ['investment-calculator', 'inflation-calculator', 'loan-prepayment-calculator', 'salary-raise-calculator'],
  ...
  },
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['body mass index calculator', 'bmi calculator for men', 'bmi calculator for women', 'bmi chart calculator', 'healthy weight calculator'],
    related: ['calorie-calculator', 'tdee-calculator', 'pounds-to-kilograms-converter'],
  ...
  },
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['daily water calculator', 'hydration calculator', 'how much water should i drink'],
    related: ['calorie-calculator', 'tdee-calculator', 'bmi-calculator', 'gallons-to-liters-converter'],
  ...
  },
  {
    ...
    updatedAt: '2026-09-10',
    aliases: ['mi to km converter', 'distance converter', 'km to miles calculator'],
    related: ['pounds-to-kilograms-converter', 'gallons-to-liters-converter', 'fahrenheit-to-celsius-converter', 'running-pace-calculator'],
  ...
  },
  {
    ...
    category: 'measurements',
    updatedAt: '2026-09-10',
    aliases: ['f to c converter', 'temperature converter', 'celsius to fahrenheit calculator', 'degree converter'],
    related: ['miles-to-kilometers-converter', 'pounds-to-kilograms-converter', 'gallons-to-liters-converter', 'concrete-calculator'],
  ...
  },
  {
    ...
    category: 'measurements',
    updatedAt: '2026-09-10',
    aliases: ['lbs to kg converter', 'weight converter', 'kg to pounds calculator', 'stone to kg converter'],
    related: ['bmi-calculator', 'miles-to-kilometers-converter', 'gallons-to-liters-converter', 'fahrenheit-to-celsius-converter'],
  ...
  },
  {
    ...
    category: 'measurements',
    updatedAt: '2026-09-10',
    aliases: ['gal to l converter', 'volume converter', 'liters to gallons calculator', 'fuel volume converter'],
    related: ['fuel-cost-calculator', 'miles-to-kilometers-converter', 'pounds-to-kilograms-converter', 'water-intake-calculator'],
  ...
  },
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['auto loan calculator', 'car loan calculator', 'vehicle finance calculator', 'monthly car payment estimator'],
    related: ['loan-calculator', 'emi-calculator', 'commute-cost-calculator', 'fuel-cost-calculator'],
    redirectFrom: ['auto-loan-calculator', 'car-loan-calculator'],
  ...
  },
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['gas trip calculator', 'road trip fuel calculator', 'gas mileage cost calculator'],
    related: ['fuel-cost-calculator', 'commute-cost-calculator', 'travel-budget-calculator', 'toll-cost-calculator'],
  ...
  },
  {
    ...
    category: 'shopping',
    updatedAt: '2026-09-10',
    aliases: ['price per unit calculator', 'cost per ounce calculator', 'price comparison calculator', 'grocery unit price'],
    related: ['discount-calculator', 'sales-tax-calculator', 'cashback-calculator', 'fuel-cost-calculator'],
  ...
  },
  {
    ...
    category: 'time',
    updatedAt: '2026-09-10',
    aliases: ['how old am i calculator', 'date of birth calculator', 'age in days calculator', 'birthday calculator'],
    related: ['date-difference-calculator', 'pregnancy-due-date-calculator', 'visa-stay-days-calculator', 'sleep-time-calculator'],
  ...
  },
  {
    ...
    category: 'education',
    updatedAt: '2026-09-10',
    aliases: ['grade point average calculator', 'cgpa calculator', 'college gpa calculator', 'semester gpa calculator'],
    related: ['pomodoro-timer', 'date-difference-calculator', 'character-counter', 'sleep-time-calculator'],
  ...
  },
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['calories calculator', 'daily calorie needs calculator', 'calorie intake calculator', 'weight loss calorie calculator'],
    related: ['tdee-calculator', 'bmi-calculator', 'running-pace-calculator'],
  ...
  },
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['take home pay calculator', 'net salary calculator', 'after tax pay calculator', 'salary paycheck estimator'],
    related: ['salary-raise-calculator', 'work-hours-calculator', 'freelancer-rate-calculator', 'pto-calculator'],
  ...
  },
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['sip calculator', 'return on investment calculator', 'roi calculator', 'portfolio growth calculator', 'retirement savings calculator'],
    related: ['compound-interest-calculator', 'inflation-calculator', 'paycheck-calculator', 'currency-converter'],
  ...
  },
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['total daily energy expenditure calculator', 'maintenance calories calculator', 'tdee and bmr calculator'],
    related: ['calorie-calculator', 'bmi-calculator', 'running-pace-calculator'],
    redirectFrom: ['bmr-calculator'],
  ...
  // ── Time & Date ────────────────────────────────────────────────────────────
  {
    ...
    category: 'time',
    updatedAt: '2026-09-10',
    aliases: ['timesheet calculator', 'hours worked calculator', 'time card calculator', 'shift hours calculator'],
    related: ['paycheck-calculator', 'pto-calculator', 'meeting-cost-calculator', 'freelancer-rate-calculator'],
  ...
  },
  {
    ...
    category: 'time',
    updatedAt: '2026-09-10',
    aliases: ['days between dates calculator', 'date duration calculator', 'countdown calculator', 'weeks between dates', 'days until date'],
    related: ['age-calculator', 'visa-stay-days-calculator', 'pto-calculator', 'work-hours-calculator'],
  ...
  },
  {
    ...
    category: 'time',
    updatedAt: '2026-09-10',
    aliases: ['bedtime calculator', 'sleep cycle calculator', 'wake up time calculator', 'when should i sleep'],
    related: ['pomodoro-timer', 'timezone-meeting-planner', 'age-calculator', 'tdee-calculator'],
  ...
  // ── Finance (new) ──────────────────────────────────────────────────────────
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['extra payment calculator', 'early payoff calculator', 'mortgage payoff calculator', 'interest saved calculator'],
    related: ['mortgage-calculator', 'loan-calculator', 'emi-calculator', 'compound-interest-calculator'],
  ...
  },
  {
    ...
    category: 'finance',
    updatedAt: '2026-09-10',
    aliases: ['purchasing power calculator', 'cost of living calculator', 'value of money over time calculator', 'price increase calculator'],
    related: ['compound-interest-calculator', 'investment-calculator', 'salary-raise-calculator', 'electricity-bill-calculator'],
  ...
  // ── Work & Career ──────────────────────────────────────────────────────────
  {
    ...
    category: 'work',
    updatedAt: '2026-09-10',
    aliases: ['pay rise calculator', 'percentage increase in salary', 'promotion pay calculator', 'new salary calculator'],
    related: ['paycheck-calculator', 'inflation-calculator', 'freelancer-rate-calculator'],
  ...
  },
  {
    ...
    category: 'work',
    updatedAt: '2026-09-10',
    aliases: ['cost of meeting calculator', 'meeting time cost', 'salary per hour meeting cost'],
    related: ['work-hours-calculator', 'freelancer-rate-calculator', 'paycheck-calculator', 'pomodoro-timer'],
  ...
  },
  {
    ...
    category: 'work',
    updatedAt: '2026-09-10',
    aliases: ['hourly rate calculator', 'contractor rate calculator', 'day rate calculator', 'consulting fee calculator'],
    related: ['paycheck-calculator', 'work-hours-calculator', 'meeting-cost-calculator', 'salary-raise-calculator'],
  ...
  },
  {
    ...
    category: 'work',
    updatedAt: '2026-09-10',
    aliases: ['vacation days calculator', 'paid time off accrual calculator', 'annual leave calculator', 'holiday allowance calculator'],
    related: ['work-hours-calculator', 'paycheck-calculator', 'date-difference-calculator', 'travel-budget-calculator'],
  ...
  // ── Auto (new) ─────────────────────────────────────────────────────────────
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['electric car charging cost', 'ev running cost calculator', 'kwh charging calculator'],
    related: ['fuel-cost-calculator', 'electricity-bill-calculator', 'commute-cost-calculator', 'gas-cost-calculator'],
  ...
  },
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['toll estimator', 'highway toll calculator', 'road toll cost'],
    related: ['commute-cost-calculator', 'gas-cost-calculator', 'travel-budget-calculator', 'fuel-cost-calculator'],
  ...
  },
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['cost of commuting calculator', 'daily travel cost calculator', 'work travel expense calculator'],
    related: ['fuel-cost-calculator', 'toll-cost-calculator', 'ev-charging-calculator', 'paycheck-calculator'],
  ...
  // ── Health (new) ───────────────────────────────────────────────────────────
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['pace per mile calculator', 'marathon pace calculator', 'race time calculator', 'min per km calculator'],
    related: ['calorie-calculator', 'miles-to-kilometers-converter', 'tdee-calculator', 'sleep-time-calculator'],
  ...
  },
  {
    ...
    category: 'health',
    updatedAt: '2026-09-10',
    aliases: ['due date calculator', 'conception date calculator', 'pregnancy week calculator', 'edd calculator'],
    related: ['age-calculator', 'date-difference-calculator', 'bmi-calculator', 'water-intake-calculator'],
  ...
  // ── Home (new) ─────────────────────────────────────────────────────────────
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['how much paint do i need', 'wall paint coverage calculator', 'paint gallons calculator'],
    related: ['wallpaper-calculator', 'tile-calculator', 'concrete-calculator', 'furniture-fit-calculator'],
  ...
  },
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['how many tiles do i need', 'floor tile calculator', 'tile area calculator'],
    related: ['paint-calculator', 'wallpaper-calculator', 'concrete-calculator', 'furniture-fit-calculator'],
  ...
  },
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['cubic yards of concrete calculator', 'cement calculator', 'slab concrete calculator'],
    related: ['tile-calculator', 'paint-calculator', 'wallpaper-calculator', 'gallons-to-liters-converter'],
  ...
  },
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['wallpaper rolls calculator', 'how much wallpaper do i need', 'wall covering calculator'],
    related: ['paint-calculator', 'tile-calculator', 'furniture-fit-calculator', 'concrete-calculator'],
  ...
  },
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['will it fit calculator', 'room layout calculator', 'doorway fit calculator'],
    related: ['paint-calculator', 'tile-calculator', 'wallpaper-calculator', 'miles-to-kilometers-converter'],
  ...
  // ── Shopping ───────────────────────────────────────────────────────────────
  {
    ...
    category: 'shopping',
    updatedAt: '2026-09-10',
    aliases: ['percent off calculator', 'sale price calculator', 'markdown calculator', 'savings calculator'],
    related: ['sales-tax-calculator', 'cashback-calculator', 'unit-price-calculator'],
  ...
  },
  {
    ...
    category: 'shopping',
    updatedAt: '2026-09-10',
    aliases: ['reward points calculator', 'credit card cashback calculator', 'rebate calculator'],
    related: ['discount-calculator', 'sales-tax-calculator', 'unit-price-calculator'],
  ...
  },
  {
    ...
    category: 'home',
    updatedAt: '2026-09-10',
    aliases: ['power bill estimator', 'kwh cost calculator', 'appliance running cost calculator', 'energy bill calculator'],
    related: ['ev-charging-calculator', 'inflation-calculator', 'fuel-cost-calculator', 'travel-budget-calculator'],
  ...
  },
  {
    ...
    category: 'auto',
    updatedAt: '2026-09-10',
    aliases: ['petrol cost calculator', 'diesel cost calculator', 'trip fuel calculator', 'mpg cost calculator'],
    related: ['gas-cost-calculator', 'commute-cost-calculator', 'ev-charging-calculator', 'toll-cost-calculator'],
  ...
  },
  {
    ...
    category: 'time',
    updatedAt: '2026-09-10',
    aliases: ['focus timer', 'study timer', '25 minute timer', 'productivity timer'],
    related: ['sleep-time-calculator', 'work-hours-calculator', 'meeting-cost-calculator'],
